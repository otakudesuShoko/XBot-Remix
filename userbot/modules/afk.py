...
# ========================= CONSTANTS ============================
AFKSTR = [
    "❗**AFK**\n  ➥ `Bos gua sedang sibuk!!`",
    "❗**AFK**\n  ➥ `Bos gua lagi ngocok asu!!",
    "❗**AFK**\n  ➥ `Gua lagi ngopi\n  ➥ `Gausah spam!!`",
    "❗**AFK**\n  ➥ `Sorry bos gua lagi off anjim!!`",
]
...
async def set_afk(afk_e):
    ...
    if BOTLOG: 
        await afk_e.client.send_message(BOTLOG_CHATID, "⚠️ AFK\nAnda sekarang  offline!")
    ISAFK = True
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("**Oke Urusan gua dah kelar....**")
        time.sleep(3)
        await msg.delete()
        ...
        if BOTLOG:
            await notafk.client.send_message(
                BOTLOG_CHATID,
                "Anda menerima " + str(COUNT_MSG) + " Chat dari  " +
                str(len(USERS)) + "si  Anak dajjal saat anda Off",
            )
            for i in USERS:
                ...
                await notafk.client.send_message(
                    ...
                    " Mengirimi " + "`" + str(USERS[i]) + " Chat Untuk anda`",
                )
        COUNT_MSG = 0
        USERS = {}
        AFKREASON = None
